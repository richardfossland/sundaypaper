 ...
 *
 * The app is dark-first: the default tokens are dark, the `prefers-color-scheme`
 * media query lights them up, and a `.light` / `.dark` class on <html> lets the
 * user force a mode. So:
